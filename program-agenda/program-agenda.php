...
";
    ...
    private function nav($active = 'programs', $editing_title = '') {
        ...
        if (!empty($_GET['bulk_error'])) { echo '<div class="notice notice-error is-dismissible"><p>Bulk update could not be completed. Select items, then choose at least one change: move to Draft, delete, assign a program/program style, or assign a sponsor level.</p></div>'; }
    ...
    public function page_programs() {
        ...
        echo '<a class="pa-add-new" href="' . esc_url(admin_url('admin.php?page=program-main')) . '">Add new</a>';
